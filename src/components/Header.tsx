        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between relative">
            ...
            <ul
              ...
              } absolute top-3 left-0 w-full bg-white shadow-md z-10 p-4 rounded-lg lg:static lg:flex lg:items-center lg:gap-6 lg:shadow-none lg:bg-transparent`}
            >
          ...
          <div className="block lg:hidden mt-4">
            <div className="relative">
              ...
              <input
                placeholder="Search for products..."
                type="text"
                className="pl-14 pr-14 outline-none w-full bg-gray-200 rounded-3xl py-2"
              />
            </div>
          </div>
        </div>
